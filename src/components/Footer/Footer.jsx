  ...
  return (
    <footer className="bg-darkBlue text-white relative mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        {/* Policies Section */}
        <div>
          <h4 className="text-2xl font-semibold mb-4">Policies</h4>
          <ul className="space-y-3">
            <li>
              <Link href="/policies/about" className="hover:text-lightBlue text-lg">
                About
              </Link>
            </li>
            <li>
              <Link href="/policies/contact" className="hover:text-lightBlue text-lg">
                Contact
              </Link>
            </li>
            <li>
