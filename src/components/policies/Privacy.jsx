    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 px-4 mt-20">
      <div className="max-w-4xl w-full bg-white shadow-lg rounded-lg p-6 md:p-10">
        ...
        <div className="space-y-6 text-gray-700 text-lg">
          <p>
            At <strong>Code4Bharat</strong>, we are committed to safeguarding your privacy. This policy explains how we
          ...
          <ul className="list-decimal list-inside space-y-4">
            ...
            <li>
              ...
              <p>
                <strong>NexCore-Alliance</strong> reserves the right to update this privacy policy to reflect changes in our
