          ...
          <div className="space-y-6 text-gray-700 text-lg">
            ...
            <ol className="list-decimal list-inside space-y-4 pl-4">
              ...
              <li>
                ...
                <ul className="list-disc list-inside ml-6">
                  <li>Industry-standard encryption to protect sensitive information.</li>
              ...
              <li>
                ...
                <p>Your data is never shared with third parties except for:</p>
                <ul className="list-disc list-inside ml-6">
                  <li>Secure payment processing via trusted payment gateways.</li>
                </ul>
              </li>
              ...
              <li>
                ...
                <p>
                  ...
                  this privacy policy to reflect changes in practices or legal requirements.
                </p>
                <ul className="list-disc list-inside ml-6">
