  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Learn about how Code4Bharat protects your privacy with this detailed Privacy Policy." />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="keywords" content="Privacy Policy, Code4Bharat, Data Protection, User Privacy" />
      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100 px-4 mt-20">
        <div className="max-w-4xl w-full bg-white shadow-lg rounded-lg p-6 md:p-10">
          ...
          <div className="space-y-6 text-gray-700 text-lg">
            <p>
              At <strong>Code4Bharat</strong>, we are committed to safeguarding your privacy. This policy explains how
              we collect, use, and protect your personal information to ensure a secure and transparent experience.
            </p>
            <ul className="list-decimal list-inside space-y-4">
              ...
              <li>
                ...
                <p>We take your data security seriously and have implemented the following measures:</p>
                <ul className="list-disc list-inside ml-4">
              ...
              <li>
                ...
                <p>Your data is never shared with third parties except in the following scenarios:</p>
                <ul className="list-disc list-inside ml-4">
              ...
              <li>
                ...
                <p>
                  <strong>NexCore-Alliance</strong> reserves the right to update this privacy policy to reflect changes
            ...
            <p>
              ...
              <strong>NexCore-Alliance</strong>, your privacy and trust are of utmost importance to us.
            </p>
          </div>
        </div>
      </div>
