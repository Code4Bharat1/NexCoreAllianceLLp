  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Read the terms and conditions for using the NexCore-Alliance platform and its services. Ensure compliance and understand your rights and responsibilities." />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="keywords" content="Terms and Conditions, NexCore-Alliance, User Agreement, Platform Rules" />
        <meta name="author" content="NexCore-Alliance" />
        <meta property="og:title" content="Terms and Conditions | NexCore-Alliance" />
        <meta property="og:description" content="Understand the terms and conditions for accessing and using the NexCore-Alliance platform." />
        <meta property="og:url" content="https://nexcorealliance.com/terms-and-conditions" />
      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100 px-4">
        <div className="max-w-4xl w-full bg-white shadow-lg rounded-lg p-6 md:p-10">
          ...
          <div className="space-y-6 text-gray-700 text-lg">
            <p>
              Welcome to <strong>NexCore-Alliance</strong>. By accessing or using our website{' '}
              (<a href="https://nexcorealliance.com/" className="text-blue-500 hover:underline">
            ...
            <ol className="list-decimal list-inside space-y-4">
              ...
              <li>
                ...
                by <strong>NexCore-Alliance</strong> and protected by copyright laws. Unauthorized sharing, duplication, 
                or distribution is strictly prohibited and may lead to legal action.
              </li>
              <li>
                <strong>Service Modifications:</strong> <strong>NexCore-Alliance</strong> reserves the right to modify, suspend, 
            ...
            {/* Uncomment if you have a dedicated link to detailed terms and conditions */}
            {/* <p>
              For further details, please refer to the complete terms and conditions at&nbsp;
              <a href="https://nexcorealliance.com/terms" className="text-blue-500 hover:underline">
                Terms & Conditions
              </a>.
            </p> */}
          </div>
